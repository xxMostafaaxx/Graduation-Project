...
class UserProvider with ChangeNotifier {
  ...
  Future<void> loadUserProfile() async {
    try {
      ...
      final response = await dio.get('https://medmatch.onrender.com/profile');
  ...
  Future<List<Drug>> fetchDrugs() async {
    ...
    final response = await dio.get('https://medmatch.onrender.com/drugs?page=$_currentPage');
  ...
  Future<void> searchDrugs(String query, int page) async {
    try {
      ...
      final response = await dio.get("https://medmatch.onrender.com/search?search=$query&page=$page");
      if (response.statusCode == 200) {
  ...
  Future<Map<String, dynamic>> getDrugDetails(String id) async {
    try {
      ...
      final response = await dio.get("https://medmatch.onrender.com/drug/$id");
      if (response.statusCode == 200) {
  ...
  Future<List<Drug>> getSimilarDrugs(String id, int similarPage) async {
    try {
      final response = await Dio().get('https://medmatch.onrender.com/similarDrugs/$id?page=$similarPage');
  ...
  Future<Map<String, dynamic>> fetchCartData() async {
    try {
      ...
      final response = await dio.get('https://medmatch.onrender.com/cart');
      final data = response.data;
  ...
  Future<void> deleteDrugFromCart(String drugId) async {
    ...
    final url = 'https://medmatch.onrender.com/cart/removeItem/$drugId';
  ...
  Future<List<Order>> fetchOrders() async {
    ...
    try {
      final response = await dio.get('https://medmatch.onrender.com/order/Orders');
  ...
  Future<void> deleteOrder(String cartId) async {
    ...
    final url = 'https://medmatch.onrender.com/order/cancelOrder/$cartId';
  ...
  Future<void> deleteAllHistory() async {
    ...
    final url = 'https://medmatch.onrender.com/deleteAllHistory';
  ...
  Future<void> addToCart(String drugId, int quantity) async {
    ...
    dio.options.headers['Authorization'] = 'Bearer $token';
    try {
      var url = 'https://medmatch.onrender.com/cart/addToCart/$drugId';
  ...
  Future<void> checkout(String shippingAddress, String phone, String paymentMethod) async {
    try {
      ...
      Response response = await dio.post(
        'https://medmatch.onrender.com/order/checkout',
        data: {
  ...
  Future<void> updateUserName(String newUserName) async {
    ...
    const url = 'https://medmatch.onrender.com/editUser';
    final headers = {
